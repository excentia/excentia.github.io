...
Nuestro primer paso es el uso de la herramienta [SonarQube](https://www.excentia.es/sonarsource). Esto nos ayuda a detectar errores y tener un código limpio con gran facilidad, evitando perder tiempo de trabajo revisando el código, línea por línea manualmente.
