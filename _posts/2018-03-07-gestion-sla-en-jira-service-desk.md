...
description: Los SLA (Service Level Agreement) o en castellano ANS (Acuerdos de Nivel de Servicio) son acuerdos o contratos que realiza un proveedor de servicios con un cliente interno o externo. Este compromiso entre servicio y cliente ayuda a medir la calidad de los servicios contratados. 
...
<a href="http://www.excentia.es/atlassian" target="_blank"><img class="center" width="100%" alt="Gestión de SLA en Jira Service Desk" title="Gestión de SLA en Jira Service Desk" src="/img/posts/2018-03-07-gestion-sla-jira-service-desk.png"></a>
...
## ¿Qué es un SLA?
En el mundo de los servicios, los SLA (Service Level Agreement) o en castellano ANS (Acuerdo de Nivel de Servicio) son acuerdos o contratos que realiza un proveedor de servicios con un cliente interno o externo. Este compromiso entre servicio y cliente ayuda a medir la calidad de los servicios contratados. 
