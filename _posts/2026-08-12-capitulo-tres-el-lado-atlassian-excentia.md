---
layout: post
title: 'EP 3 - El Lado Atlassian de excentia: Últimas novedades para Jira y Rovo'
description: Te contamos tres de las nuevas funcionalidades de Jira y Rovo en un nuevo capítulo de nuestro videopodcast.
...
cover: /img/posts/2026-08-12-capitulo-tres-el-lado-atlassian-excentia.png

---

El verano también trae novedades al ecosistema Atlassian. Así que hemos querido aprovechar el **lanzamiento de Jira Summer 2026** para dedicar el tercer episodio de **El Lado Atlassian de excentia** a tres funcionalidades que creemos que merecen una explicación más allá de la típica lista de novedades.

En este nuevo capítulo **hablamos de Jira y Rovo**, pero, sobre todo, de cómo estas nuevas funcionalidades pueden cambiar la forma en la que los equipos gestionan su trabajo, consultan la información y toman decisiones dentro del ecosistema Atlassian.
...
<iframe width="660" height="415" src="https://www.youtube.com/embed/q2yPJIrWiOA?si=mMadZrSTBGnsjUN5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>