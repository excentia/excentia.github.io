...
¡La revolución del Cloud ha llegado a Atlassian! Uno de los platos fuertes del Team '25 ha sido todas las novedades que se han anunciado para Atlassian Cloud Platform: nuevas aplicaciones predefinidas, una nueva modalidad Cloud para los clientes reacios a migrar a la nube... Aquí te contamos punto por punto en qué consisten estas novedades. 
...
¿Por qué se realiza este cambio? Tal y como informan desde Atlassian es algo "crucial en la forma en la que desarrollamos y ofrecemos innovación a nuestros clientes". Las aplicaciones se empaquetan e integran de forma modular, lo que otorga más **flexibilidad, coherencia y conexión entre los datos** para los equipos. La palabra 'aplicación' representa mejor esta filosofía de conectividad Atlassian que la palabra 'producto', que puede dar a entender a una **solución única y no conectada**. 

<h2>2 - Aplicaciones nativas de la plataforma</h2>

Atlassian Cloud Platform tendrá **aplicaciones predefinidas** como "las que puede tener integradas un móvil". Estas aplicaciones tienen como objetivo dar visibilidad, alinear y facilitar la toma de decisiones a los equipos.
...
✅ **Home**: Vista personalizada del trabajo que estás realizando de todas las aplicaciones. Home utilizará el Teamwork Graph para ofrecer tareas recomendadas de todas las aplicaciones de Atlassian. También incluirá Dashboards para que veas los progresos de tus tareas de forma más visual. 

✅ **Goals**: Los objetivos ayudan a los usuarios a ver el progreso y como su trabajo contribuye a la estrategia empresarial. Además, gracias a Teamwork Graph se conecta el trabajo relacionado, independientemente de dónde se esté monitoreando. 

✅ **Team**: Teams ayuda a los equipos a ver la descripción de los usuarios, en qué están trabajando y cómo se conectan entre sí. 
...
<h2>3 - Nueva modalidad: Atlassian Cloud Isolate</h2>

Con el objetivo de que los clientes tengan más acceso a la nube, Atlassian ha anunciado una nueva modalidad de implementación en la nube: Atlassian Cloud Isolate que se suma a la modalidad de Atlassian Government Cloud. A continuación, te explicamos cuáles son sus características y diferencias. 

▶️ **Atlassian Cloud Isolate**: Es una modalidad Cloud de un solo inquilino, que incluirá servidores dedicados, almacenamiento, aplicaciones y bases de datos aisladas en una **nube privada virtual**. De esta forma, los clientes estrictos tendrán una oportunidad para aprovechar la innovación y la eficiencia de Atlassian Cloud, con la seguridad y el control de un entorno dedicado. Esta modalidad estará disponible en el año 2026.

▶️ **Atlassian Government Cloud**: Es un **entorno autorizado FedRAMP Moderado**. Tiene un uso limitado para agencias gubernamentales de EE.UU. y socios industriales. Esta modalidad requiere una inscripción a una [lista de espera](https://www.atlassian.com/government/cloud){:target="_blank"}. 


Y hasta aquí todas las novedades de **Atlassian Cloud Platform**. No dudes en ponerte en contacto con nuestro equipo a través de este formulario si tienes alguna duda.
