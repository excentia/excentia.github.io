---
layout: post
title: 'Sonar adquiere Gitar'
description: Sonar anuncia la adquisición de Gitar para reforzar su plataforma de verificación de código con inteligencia artificial. 
date: '2026-05-21T08:00:00Z'
author: Tariq Shaukat
categories:
...
cover: /img/posts/2026-05-21-bienvenida-gitar-sonar.png
...
<h2>Por qué Gitar es clave para la plataforma de verificación SonarQube</h2>
...
De estos tres pilares, el de **verificar** siempre ha sido el más crítico. La verificación es obligatoria en [AC/DC](https://www.excentia.es/sonar-agent-centric-development), no opcional. Debe ser exhaustiva, transparente y consistente. La mejor verificación es multicapa y de confianza cero.
